  ...
  for (var i = 0; i < getfilters.length; i++) {
    ...
    switch(getfilters[i].id)
    {
      ...
      case 6://ROE
        ...
        break;
      case 7://부채비율
        makefilters=Object.assign({debut_per:updownFilter[i]},makefilters);
        break;
      case 8://당좌비율
        makefilters=Object.assign({quick_ratio:updownFilter[i]},makefilters);
        break;
      case 9://유보율
        makefilters=Object.assign({reserv_ratio:updownFilter[i]},makefilters);
        break;
      case 10://EPS
